        ...
        <Formik
          ...
          onSubmit={async (values, formikHelpers) => {
            ...
            if (response.ok) {
              ...
              setPopup({
                message: isUpdate
                  ? `Error updating ExpertxBot config - ${errorMsg}`
                  : `Error creating ExpertxBot config - ${errorMsg}`,
                type: "error",
              });
            }
          }}
            ...
            <Form>
              <div className="px-6 pb-6">
                ...
                <TextArrayField
                  ...
                  subtext={
                    <div>
                      ...
                      <br />
                      <br />
                      <i>NOTE</i>: you still need to add ExpertxBot to the
                ...
                <SelectorFormField
                  ...
                  subtext={
                    <>
                      If set to Citations, ExpertxBot will respond with a direct
                      answer with inline citations. It will also provide links
                      to these cited documents below the answer. When in doubt,
                      choose this option.
                      <br />
                      <br />
                      If set to Quotes, ExpertxBot will respond with a direct
                      answer as well as with quotes pulled from the context
                      documents to support that answer. ExpertxBot will also
                ...
                <SectionHeader>When should ExpertxBot respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @DExpertxBot Only"
                  subtext="If set, ExpertxBot will only respond when directly tagged"
                />
                <BooleanFormField
                  name="respond_to_bots"
                  label="Responds to Bot messages"
                  subtext="If not set, ExpertxBot will always ignore messages from Bots"
                />
                <TextArrayField
                  name="respond_team_member_list"
                  label="Team Members Emails"
                  subtext={`If specified, BExpertxot responses will only be 
                  visible to members in this list. This is
                  useful if you want ExpertxBot to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of ExpertxBot's response / throw 
                ...
                <BooleanFormField
                  ...
                  label="Should Expertx give a “Still need help?” button?"
                  subtext={`If specified, ExpertxBot's response will include a button at the bottom 
                  ...
                  <TextArrayField
                    ...
                    subtext={
                      <div>
                        ...
                        handle. For example, &apos;Expertx Team&apos; or
                        &apos;Expertx-team&apos;.
                        <br />
                        <br />
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents ExpertxBot uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that ExpertxBot should search
                                through. If left blank, ExpertxBot will search
