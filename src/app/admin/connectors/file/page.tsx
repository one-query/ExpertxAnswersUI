  ...
  return (
    <div>
      ...
      <Text className="mb-2">
        ...
        these files will be searchable via Expertx! Currently only <i>.txt</i>,{" "}
      ...
      <Text className="mb-3">
        ...
        <div className="flex my-2">
          <div className="mx-auto font-bold">
            #Expertx_METADATA={"{"}&quot;link&quot;: &quot;{"<LINK>"}&quot;{"}"}
          </div>
        </div>{" "}
        where <i>{"<LINK>"}</i> is the link to the file. This will enable
        Expertx to link users to the original document when they click on the
