      ...
      body = (
        <>
          ...
          <div className="mt-3">
            ...
            <div>
              <p>
                Connectors are the way that Expertx gets data from your
                organization&apos;s various data sources. Once setup, we&apos;ll
                automatically sync data from your apps and docs into Expertx, so
    ...
    case "chat":
      ...
      body = (
        <>
          ...
          <div className="mt-3">
            <div>
              To start using Expertx as a secure ChatGPT, we just need to
              configure our LLM!
              <br />
              <br />
              Expertx supports connections with a wide range of LLMs, including
      ...
      break;
    default:
      title = "🎉 Welcome to Expertx";
      body = (
        <>
          <div>
            <p>How are you planning on using Expertx?</p>
          </div>
          <Divider />
          <UsageTypeSection
